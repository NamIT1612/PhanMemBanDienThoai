...
namespace DoAn_PTPM_UDTM.QL_BanDienThoaiDataSetTableAdapters {
...
SELECT SoLuongBan, GiaBan, NgayBan, MaKhachHang FROM HOADON WHERE (MaKhachHang = @MaKhachHang) AND (NgayBan = @NgayBan)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DoAn_PTPM_UDTM.Properties.Settings.Default.QL_BanDienThoaiConnectionString;
        }
...
SELECT MaLoai, TenLoaiSP FROM LOAISANPHAM WHERE (MaLoai = @MaLoai)";
    ...
    public partial class SANPHAMTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TenSP, MaSP FROM SANPHAM WHERE MaSP IN (SELECT MaSP FROM HOADON WHERE MaKh" +
                "achHang=@makh and TrangThai=@tt)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@makh", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@tt", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(QL_BanDienThoaiDataSet.SANPHAMDataTable dataTable, string makh, global::System.Nullable<int> tt) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((makh == null)) {
                throw new global::System.ArgumentNullException("makh");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual QL_BanDienThoaiDataSet.SANPHAMDataTable GetData(string makh, global::System.Nullable<int> tt) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((makh == null)) {
                throw new global::System.ArgumentNullException("makh");
            }
